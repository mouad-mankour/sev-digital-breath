    ...
    <section className="py-16 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-20">
          {dataSteps.map((step, index) => <div key={step.title} className="relative">
              {/* Connecteur entre les étapes */}
              {index < dataSteps.length - 1 && <div className="hidden md:block absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 z-10">
                  <ArrowRight className="w-8 h-8 text-accent/60" style={{

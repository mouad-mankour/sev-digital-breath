...
export function MediaBuying() {
  return (
    <section className="py-16 sm:py-20 md:py-24 relative bg-gradient-to-b from-background to-muted/20">
      {/* Background pattern */}
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 px-4 md:px-0">
              ...
              <Button 
                variant="hero" 
                size="lg" 
                className="w-full md:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg hover:scale-105 transition-all duration-200"
              ...
              <div className="card-float bg-gradient-to-br from-card to-card/50 border border-primary/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl backdrop-blur-sm">
                <div className="space-y-4 sm:space-y-6">
                  {[
                    ...
                    <div 
                      key={item.label}
                      className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-r from-muted/30 to-background/30 border border-border/50"

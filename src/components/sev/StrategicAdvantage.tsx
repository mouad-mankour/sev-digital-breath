  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-10 sm:top-20 left-4 sm:left-20 w-48 sm:w-96 h-48 sm:h-96 rounded-full bg-gradient-to-br from-emerald-500/20 to-teal-600/20 blur-3xl animate-float" />
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className={`text-center mb-12 sm:mb-16 md:mb-20 transition-all duration-1500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          <div className="relative inline-block mb-6 sm:mb-8 px-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-white via-sev-accent via-sev-primary to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_200%] leading-tight">
              L'Atout Stratégique
            </h2>
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold bg-gradient-to-r from-sev-primary to-sev-secondary bg-clip-text text-transparent">
              de Databblead
            </div>
            {/* Underline effect */}
          ...
          <div className="relative p-6 sm:p-8 md:p-12 lg:p-16 rounded-2xl sm:rounded-3xl backdrop-blur-xl bg-gradient-to-br from-white/5 to-white/10 border border-white/20 shadow-2xl mx-4">
            ...
            <div className="relative z-10 space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col items-center justify-center gap-2 sm:gap-4 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200">
                ...
                <span className="px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-violet-500/20 to-purple-600/20 text-violet-300 font-bold border border-violet-400/30 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16 md:mb-20 px-4">
          {differentiators.map((item, index) => (
            <div
              key={index}
              className={`group relative text-center p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl backdrop-blur-xl border transition-all duration-700 hover:transform hover:scale-105 sm:hover:scale-110 hover:rotate-1 ${isVisible ? 'opacity-100 translate-y-0 rotate-0' : 'opacity-0 translate-y-16 rotate-3'}`}
              style={{ 
        ...
        <div className={`text-center px-4 transition-all duration-1500 delay-1200 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-95'}`}>
          <div className="relative inline-block w-full sm:w-auto">
            ...
            <Button
              ...
              className="relative group px-8 sm:px-12 md:px-16 py-4 sm:py-6 md:py-8 text-lg sm:text-xl md:text-2xl font-bold rounded-full 
                         ...
                         overflow-hidden
                         w-full sm:w-auto max-w-lg sm:max-w-none mx-auto"
